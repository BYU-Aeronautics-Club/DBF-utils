...
\begin{figure}[h!]
	\centering
	\includegraphics[width=4in]{draft4x3}
...
\begin{table}[h!]
	...
	\cellcolor{white} & Angle of Attack & Value & Side Slip Angle & Value & Roll Rate & Value & Pitch Rate & Value & Yaw rate & Value  \\
...
\arrayrulecolor{BYUgray}\hline
				& $\square$ & Task  \\
				& $\square$ & Task  \\
				& $\square$ & Task  \\
				& $\square$ & Task  \\
		\multirow{-5}{*}{Component} & $\square$ & Task  \\
\arrayrulecolor{BYUgray}\hline
				& $\square$ & Task  \\
				& $\square$ & Task  \\
				& $\square$ & Task  \\
